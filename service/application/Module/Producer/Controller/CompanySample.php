...
use Module\Producer\Model\CompanySampleModel;
 ...
 */
class CompanySample extends Api
{
    ...
    public function create()
    {
        ...
        $this->preProcessData($data, CompanySampleModel::$fields);
        $companySampleModel = new CompanySampleModel();
        $data['time_created'] = $data['time_updated'] = date('Y-m-d H:i:s');
        try {
            $id = $companySampleModel->add($data);
            return $this->export([
                'data' => [
                    'id' => $id
                ]
    ...
    public function update()
    {
        ...
        try {
            $result = $companySampleModel->update($data, ['id=?', [$data['id']]]);
            return $this->export([
                'data' => [
                    'result' => $result
                ]
    ...
    public function delete()
    {
        ...
        $companySampleModel = new CompanySampleModel();
        try {
            $result = $companySampleModel->delete(['id=?', [$id]]);
   ...
   /**
    ...
    public function getStation()
    {
        ...
        try {
            // 基本信息
            $item = $companySampleModel->getOne('*', ['name=?', [$name]]);
            if (empty($item)) {
                return $this->export([
            ...
            $companySampleModel->formatItems($item);
            return $this->export([
                'data' => [
    ...
    public function getItem()
    {
        ...
        try {
            // 基本信息
            $item = $companySampleModel->getOne('*', ['id=?', [$id]]);
            if (empty($item)) {
                return $this->export([
                    'code' => $this->code('UNIT_NOT_FOUND'),
                    'message' => '生产单位不存在'
    ...
    public function getItems()
    {
        ...
        try {
            // 基本信息
            $items = $companySampleModel->getItems([
                'ids' => $unitIds,
            ]);
            if (empty($items)) {
                return $this->export([
    ...
    public function getList()
    {
        ...
        $result = $companySampleModel->getList($params);
        return $this->export([
            'data' => $result
        ]);
    }
    ...
    public function getAll()
    {
        ...
        $result = $companySampleModel->getAll($params);
        return $this->export([
            'data' => $result
        ]);
    }
