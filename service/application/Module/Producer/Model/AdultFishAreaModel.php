 ...
 * @package Module\Porducer\Model
 */
class AdultFishAreaModel extends BaseModel
{
    ...
    public function getList($params = array()) {
        $params = array_merge(array(
            'fields' => '*',
            'order'  => 'quarter DESC, unit_id ASC, way_id asc',
            'pager'   => array()
        ), $params);
        $conditions = '';
        $binds = [];
    ...
    public function getSum($params = array()) {
        $params = array_merge(array(
            'fields' => '*',
            'order'  => 'quarter DESC, way_id asc',//, unit_id ASC
            'pager'   => array()
        ), $params);
        $conditions = '';
        $binds = [];
