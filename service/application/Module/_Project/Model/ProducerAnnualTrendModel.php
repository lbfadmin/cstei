...
/**
 * 企业年度趋势
 * Class ProducerAnnualTrendModel
 * @package Module\Project\Model
 */
class ProducerAnnualTrendModel extends BaseModel
{
    protected $table = '{statistic_producer_annual_trend}';

    public static $fields = [
        'id', 'production_unit_id', 'year', 'revenue'
    ];
