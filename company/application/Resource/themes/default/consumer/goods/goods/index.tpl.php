...
<head>
    <meta charset="utf-8" />
    <title>商品管理 - <?=$_TPL['site_name']?></title>
        ...
        <div class="page-content">
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject font-dark bold">商品列表</span>
                    </div>
                    <div class="actions">
                        <a class="btn btn-circle btn-primary" href="<?=url('consumer/goods/goods/add') ?>">
                        ...
                        <?php if (!empty($result->list)):?>
                            <?php foreach ($result->list as $item):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="/consumer/goods/goods/edit?id=<?=$item->id?>" data-toggle="tooltip" title="" class="btn btn-default btn-xs" ><i class="fa fa-edit"></i> 编辑</a>
...
<script>
    $(function () {
        $('[data-role=delete]').on('click', function () {
            ...
            layer.confirm('您确定要删除这条商品吗？', function () {
                $.ajax({
                    url: '/consumer/ajax/goods/goods/delete',
                    type: 'post',
                    data: {id: id},
