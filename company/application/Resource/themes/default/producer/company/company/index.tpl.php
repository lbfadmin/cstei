...
<html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>试验站管理 - <?=$_TPL['site_name']?></title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="javascript:">试验站端</a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <a href="javascript:">试验站管理</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject font-dark bold">试验站列表</span>
                            </div>
                            <div class="actions">
                                <a class="btn btn-circle btn-primary" href="<?=url('producer/company/company/add') ?>">
                                    <i class="fa fa-plus"> 添加试验站</i>
                                </a>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <form class="form-inline area-selector" style="margin-bottom: 15px">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">试验站名称</span>
                                        <input class="form-control" name="name" placeholder="试验站名称" value="<?=$this->input->getString('name')?>">
                                    </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="col-md-3">基本信息</th>
                                    <th class="col-md-1">规模</th>
                                    <th class="col-md-3">主要产品</th>
                                    <th>更新时间</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                ...
                                <?php if (!empty($result->list)):?>
                                    <?php foreach ($result->list as $item):
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$item->scale ?></td>
                                            <td><p style="max-width: 300px;"><?=$item->products ?></p></td>
