...
<html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>编辑试验站 - <?=$_TPL['site_name']?></title>
...
<!--                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="/producer/company/company/index">试验站管理</a>
                            </li>
                        </ul>
                    </div>
					-->
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject font-dark bold"><?=$item ? '编辑' : '添加' ?>试验站</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="example-text-input">试验站名称 <span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="field-body">试验站规模 <span class="text-danger">&nbsp;</span></label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="field-body">试验站简介 <span class="text-danger">&nbsp;</span></label>
                                    <div class="col-md-8">
