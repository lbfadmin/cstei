                                ...
                                <?php if (!empty($result->list)):?>
                                    <?php foreach ($result->list as $item):
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="/device/device/check?id=<?=$item->id?>" data-toggle="tooltip" title="" class="btn btn-default btn-xs" ><i class="fa fa-edit"></i> 查看</a>
                                                    <a href="/device/device-use/add?deviceId=<?=$item->id?>" data-toggle="tooltip" title="" class="btn btn-default btn-xs" ><i class="fa fa-edit"></i> 申请</a>
                                                </div>
