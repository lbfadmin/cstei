    ...
    <script type="text/html" id="tpl-form">
        <form class="form form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input class="form-control" name="quarter" placeholder="季度" value="<%=item.quarter%>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input class="form-control" name="工程化池塘养殖" placeholder="平方米/立方米" value="<%=item.工程化池塘养殖%>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input class="form-control" name="深水网箱养殖" placeholder="平方米/立方米" value="<%=item.深水网箱养殖%>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input class="form-control" name="围网养殖" placeholder="平方米/立方米" value="<%=item.围网养殖%>">
                </div>
            </div>
            <div class="form-group">
