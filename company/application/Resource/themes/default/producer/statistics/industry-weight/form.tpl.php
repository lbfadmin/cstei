...
<head>
    <meta charset="utf-8" />
    <title>编辑企业产业比重 - <?=$_TPL['site_name']?></title>
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        ...
                        <a href="/producer/company/credit/index">企业产业比重管理</a>
                    </li>
                </ul>
            </div>
            <?=render_message() ?>
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject font-dark bold"><?=$item ? '编辑' : '添加' ?>企业产业比重</span>
                    </div>
                </div>
