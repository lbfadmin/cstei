...
<html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>产品种类管理 - <?=$_TPL['site_name']?></title>
                ...
                <div class="page-content">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject font-dark bold">产品种类列表</span>
                            </div>
                            <div class="actions">
                                <a class="btn btn-circle btn-primary" href="<?=url('project/product-type/add') ?>">
                                    <i class="fa fa-plus"> 添加产品种类</i>
                                </a>
                            </div>
                        </div>
                                ...
                                <?php if (!empty($list)):?>
                                    <?php foreach ($list as $item):
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="/project/product-type/edit?id=<?=$item->id?>" data-toggle="tooltip" title="" class="btn btn-default btn-xs" ><i class="fa fa-edit"></i> 编辑</a>
        ...
        $(function () {
            $('[data-role=delete]').on('click', function () {
                ...
                layer.confirm('您确定要删除这条记录吗？', function () {
                    $.ajax({
                        url: '/project/ajax/product-type/delete',
                        type: 'post',
                        data: {id: id},
