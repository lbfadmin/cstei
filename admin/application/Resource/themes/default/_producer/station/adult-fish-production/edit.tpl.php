				...
				<input type="hidden" type='id' value="<?=$item->id?>" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
							...
							<option value='1' <?php if ($item->way_id==1):?>selected<?php endif?>>工厂化</option>
							<option value='2' <?php if ($item->way_id==2):?>selected<?php endif?>>网箱</option>
							<option value='3' <?php if ($item->way_id==3):?>selected<?php endif?>>池塘</option>
							</select>
                        </div>
                    </div>
	 <?php if (!empty($cats)):?>
