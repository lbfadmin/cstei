            ...
            <div class="modal-body">
				...
				<input type="hidden" type='id' value="<?=$item->id?>" />
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<!--<input class="form-control" readonly=true name="quarter" placeholder="" value="" />-->
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3">规格 <span class="required">*</span></label>
                        <div class="col-md-8">
                            <select class="form-control" name="type" disabled>
							<option value=''>请选择规格</option>
							<option value='1' <?php if ($item->type==1):?>selected<?php endif?>>标准规格</option>
							<option value='2' <?php if ($item->type==2):?>selected<?php endif?>>超标准</option>
							</select>
                        </div>
                    </div>
	 <?php if (!empty($cats)):?>
