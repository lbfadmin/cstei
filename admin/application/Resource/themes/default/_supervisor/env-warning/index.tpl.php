...
<head>
    <meta charset="utf-8" />
    <title>环境预警数据管理 - <?=$_TPL['site_name']?></title>
        ...
        <div class="page-content">
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject font-dark bold">环境预警数据列表</span>
                    </div>
                    <div class="actions">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">编辑环境预警数据</h4>
            </div>
...
<script type="text/html" id="tpl-form">
    <form class="form form-horizontal" method="post">
        ...
        <div class="form-group">
            <label class="control-label col-md-3">预警信息 <span class="required">*</span></label>
            <div class="col-md-8">
                <textarea class="form-control" name="description"><%=item.description%></textarea>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3">预警时间 <span class="required">*</span></label>
            <div class="col-md-8">
    ...
    $(function () {
        ...
        $('[data-role=delete]').on('click', function () {
            ...
            layer.confirm('您确定要删除这条信息吗？', function () {
                $.ajax({
                    url: '/supervisor/ajax/warning/delete',
                    type: 'post',
                    data: {id: id},
        ...
        $modal.find('.ok').on('click', function () {
            ...
            $.ajax({
                url: '/supervisor/ajax/warning/' + (id ? 'update' : 'create'),
