...
<html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>编辑企业 - <?=$_TPL['site_name']?></title>
...
<!--                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="/producer/company/company/index">企业管理</a>
                            </li>
                        </ul>
                    </div>
					-->
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject font-dark bold"><?=$item ? '编辑' : '添加' ?>企业</span>
                            </div>
                        </div>
                            ...
                            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <span class="help-block">必填项，30字符以内</span>
                                    </div>
                                </div>
<!--                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="field-body">入驻类型 <span class="text-danger">&nbsp;</span></label>
                                    <div class="col-md-8">
                                        <select></select>
                                    </div>
                                </div>
...
<!--                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">营业执照 <span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="field-body">企业法人 <span class="text-danger">&nbsp;</span></label>
                                    <div class="col-md-8">
									<input type="text" name="holders" class="form-control" placeholder="" value="<?=empty($item)?'':$item->holders ?>">
                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="field-body">企业规模 <span class="text-danger">&nbsp;</span></label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
									<input type="text" name="telphone" class="form-control" placeholder="" value="<?=empty($item)?'':$item->telphone ?>">
                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="field-body">企业简介 <span class="text-danger">&nbsp;</span></label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="field-body">主营业务 <span class="text-danger">&nbsp;</span></label>
                                    <div class="col-md-8">
