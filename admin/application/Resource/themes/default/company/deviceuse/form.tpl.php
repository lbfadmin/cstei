                   ...
                   <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="javascript:">设备申请</a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <i class="fa fa-book"></i>
                                <a href="/producer/company/company/index">设备申请列表</a>
                            </li>
                        </ul>
                    </div>
                    <?=render_message() ?>
                        ...
                        <div class="portlet-body form">
                            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="example-text-input">设备申请名称 <span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="field-body">设备申请规模 <span class="text-danger">&nbsp;</span></label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="field-body">设备申请简介 <span class="text-danger">&nbsp;</span></label>
                                    <div class="col-md-8">
