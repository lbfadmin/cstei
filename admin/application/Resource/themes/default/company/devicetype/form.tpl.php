...
<html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>编辑设备类型 - <?=$_TPL['site_name']?></title>
...
<!--                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="javascript:">设备类型端</a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <i class="fa fa-book"></i>
                                <a href="/producer/company/company/index">设备类型管理</a>
                            </li>
                        </ul>
                    </div>
					-->
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject font-dark bold"><?=$item ? '编辑' : '添加' ?>设备类型</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label" for="example-text-input">设备类型名称 <span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                        <input type="text" name="type_name" class="form-control" placeholder="" value="<?=empty($item)?'':$item->type_name ?>">
