...
<div class="mbxmenu center-block">
    <p>您的位置： <a href="">首页</a>>><a href="">病害防控与远程专家服务</a><?php if($title != '病害防控与远程专家服务'):?>>><a href=""><?=$title?></a><?php endif ?></p>
</div>
...
<?php foreach ($categories->children as $item):?>
			...
			<li class="">
                <a href="/content/news/disease-control?category_id=<?=$item->id?>&name=<?=$item->name?>">
                    <h1><?=$item->name?></h1>
...
<?php endforeach;?>
			...
			<li class="">
                <a href="/content/news/remote-diagnosis">
                    <h1>远程专家服务</h1>
                    <img src="<?=$this->misc('web/img/arrright.png')?>" alt="">
                </a>
	...
	<?php if (!empty($result->list)):?>
        <div class="innercontentitem">
            <div class="innercontentitem9">
                ...
                <li class="listwz">
                    <a href="/content/news/disease-control?id=<?=$item->id?>">
                        <dd></dd>
                        <p><?=$item->title?> </p>
