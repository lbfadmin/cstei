...
<html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>循环水养殖池组管理 - <?=$_TPL['site_name']?></title>
                                                    ...
                                                    <div class="portlet light ">
                                                        <div class="portlet-title">
                                                            <div class="caption caption-md">
                                                                ...
                                                                <span class="caption-subject font-green-steel uppercase bold">循环水养殖池组列表</span>
                                                                <span class="caption-helper hide">weekly stats...</span>
                                                            </div>
                                                            <div class="actions">
                                                                <a href="javascript:" class="btn btn-primary btn-circle" data-role="add"><i class="fa fa-plus"> 添加养殖池组</i></a>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <?php if (!empty($result->list)):?>
                                                                        <?php foreach ($result->list as $item):
                                                                            ...
                                                                            <tr data-item='<?=html_attr_json($item)?>'>
                                                                                ...
                                                                                <td>
                                                                                    <div class="btn-group">
                                                                                        <a href="/farming/pool/index?group_id=<?=$item->id?>" class="btn btn-xs btn-default"><i class="fa fa-cubes"></i> 养殖池</a>
                                                                                        <a href="/farming/device-group/index?pool_group_id=<?=$item->id?>" class="btn btn-xs btn-default"><i class="fa fa-cogs"></i> 设备组</a>
                                                                                    </div>
                                                                                    <div class="btn-group">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">编辑循环水养殖池组</h4>
                    </div>
...
<script>
    $(function () {
        ...
        $modal.find('.ok').on('click', function () {
            ...
            $.ajax({
                url: '/farming/ajax/pool-group/' + (id ? 'update' : 'create'),
        ...
        $('[data-role=delete]').on('click', function () {
            ...
            layer.confirm('您确定删除这条信息吗？', function () {
                $.ajax({
                    url: '/farming/ajax/pool-group/delete?id=' + id,
                    success: function (result) {
                        layer.msg(result.message, function () {
                            window.location.reload();
                        });
