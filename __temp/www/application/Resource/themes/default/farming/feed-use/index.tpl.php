...
<head>
    <meta charset="utf-8" />
    <title>饲料投放记录 - <?=$_TPL['site_name']?></title>
                                            ...
                                            <div class="portlet light ">
                                                <div class="portlet-title">
                                                    <div class="caption caption-md">
                                                        ...
                                                        <span class="caption-subject font-green-steel uppercase bold">饲料投放记录列表</span>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">编辑饲料投放记录</h4>
            </div>
    ...
    $(function () {
        ...
        $('[data-role=delete]').on('click', function () {
            ...
            layer.confirm('您确定要删除这条信息吗？', function () {
                $.ajax({
                    url: '/farming/ajax/feed-use/delete',
                    type: 'post',
                    data: {id: id},
        ...
        $modal.find('.ok').on('click', function () {
            ...
            $.ajax({
                url: '/farming/ajax/feed-use/' + (id ? 'update' : 'create'),
